...
const WorkerServices = () => {
  ...
  const [newService, setNewService] = useState({ name: "", price: "", availableTimes: "" });
  ...
  const handleAddService = async () => {
    if (!newService.name || !newService.price || !newService.availableTimes) return;
    try {
      ...
      setNewService({ name: "", price: "", availableTimes: "" });
      setShowModal(false);
            ...
            services.map((service, index) => (
              ...
              >
                <div>
                  ...
                  <p className="text-gray-500">Available Times: {service.availableTimes}</p>
                </div>
                <button
