...
const Navbar = () => {
  ...
  const menuItems = {
    Resident: [
      ...
      { name: "Dashboard", path: "/resident-dashboard", icon: FaStopCircle },
      { name: "Your Posts", path: "/resident-posts", icon: FaStopCircle },
      { name: "Services", path: "/resident-services", icon: FaTools },
      { name: "Bookings", path: "/resident-bookings", icon: FaClipboardList },
      { name: "Community", path: "/community", icon: FaServer },
      { name: "Events", path: "/resident-events", icon: FaStreetView },
      { name: "Chat", path: "/chatpage", icon: CiChat1 },
    ],
    Worker: [
    ...
    Admin: [
      ...
      { name: "Requests", path: "/admin", icon: FaUsersCog },
      { name: "Communities", path: "/admin-communities", icon: FaUsersCog },
      { name: "Events", path: "/admin-events", icon: FaStreetView },
